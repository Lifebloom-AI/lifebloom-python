...
class TestPets:
    ...
    @parametrize
    def test_method_find_by_status(self, client: Lifebloom) -> None:
        pet = client.pets.find_by_status()
        assert_matches_type(PetFindByStatusResponse, pet, path=["response"])

    @parametrize
    def test_method_find_by_status_with_all_params(self, client: Lifebloom) -> None:
        pet = client.pets.find_by_status(
            status="available",
        )
        assert_matches_type(PetFindByStatusResponse, pet, path=["response"])
    ...
    @parametrize
    def test_raw_response_find_by_status(self, client: Lifebloom) -> None:
    ...
    @parametrize
    def test_streaming_response_find_by_status(self, client: Lifebloom) -> None:
    ...
    @parametrize
    def test_method_find_by_tags(self, client: Lifebloom) -> None:
        pet = client.pets.find_by_tags()
        assert_matches_type(PetFindByTagsResponse, pet, path=["response"])

    @parametrize
    def test_method_find_by_tags_with_all_params(self, client: Lifebloom) -> None:
        pet = client.pets.find_by_tags(
    ...
    @parametrize
    def test_raw_response_find_by_tags(self, client: Lifebloom) -> None:
    ...
    @parametrize
    def test_streaming_response_find_by_tags(self, client: Lifebloom) -> None:
...
class TestAsyncPets:
    ...
    @parametrize
    async def test_method_find_by_status(self, async_client: AsyncLifebloom) -> None:
        pet = await async_client.pets.find_by_status()
        assert_matches_type(PetFindByStatusResponse, pet, path=["response"])

    @parametrize
    async def test_method_find_by_status_with_all_params(self, async_client: AsyncLifebloom) -> None:
        pet = await async_client.pets.find_by_status(
            status="available",
        )
        assert_matches_type(PetFindByStatusResponse, pet, path=["response"])
    ...
    @parametrize
    async def test_raw_response_find_by_status(self, async_client: AsyncLifebloom) -> None:
    ...
    @parametrize
    async def test_streaming_response_find_by_status(self, async_client: AsyncLifebloom) -> None:
    ...
    @parametrize
    async def test_method_find_by_tags(self, async_client: AsyncLifebloom) -> None:
        pet = await async_client.pets.find_by_tags()
        assert_matches_type(PetFindByTagsResponse, pet, path=["response"])

    @parametrize
    async def test_method_find_by_tags_with_all_params(self, async_client: AsyncLifebloom) -> None:
        pet = await async_client.pets.find_by_tags(
            tags=["string", "string", "string"],
        )
        assert_matches_type(PetFindByTagsResponse, pet, path=["response"])
    ...
    @parametrize
    async def test_raw_response_find_by_tags(self, async_client: AsyncLifebloom) -> None:
    ...
    @parametrize
    async def test_streaming_response_find_by_tags(self, async_client: AsyncLifebloom) -> None:
