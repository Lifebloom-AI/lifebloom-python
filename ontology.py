...
ontology['function']['action'] = [
    {
        ...
        'output': {
            'type': 'object',
            'properties': {'status': {'type': 'string', 'enum': ['success', 'failure']}, 'enrichment': {'type':'string', 'description':'This is the identity activity associated with the EC2 instance.'}}},
        'disabled': 0,
        'impact': 0
    },
    {
    ...
    'output': {
        ...
        'required': ['region', 'description', 'status', 'instance_id', 'unique_id', 'id', 'type', 'title', 'severity', 'cvss_score', 'cvss_version', 'package_source']
    },
    'disabled': 0,
    'impact': 1
}
...
ontology['function']['inference'].append({
    ...
    "output": {
        ...
        "required": ["disposition", "message", "report", "recommendation_1","recommendation_2","recommendation_3","recommendation_4"]
    },
    "dynamic_structured_outputs": {
        "referential": [
            {
...
ontology['workflows'] = {'security_finding_investigation' :  {
    ...
    'output': {
        ...
        "attributes": ["disposition", "message", "recommendation_1", "recommendation_2", "recommendation_3", "recommendation_4", "report"]
    }
}
}
...
ontology['personae'] = {
    ...
    "functions": {
        "default": {"security_finding_investigation": {
            "system": (
            ...
            "original_context": {
                "historical_data": {
                    ...
                    "maintenance_schedule": [
                        {"date": "2024-06-10", "start_time": "01:00:00Z", "end_time": "03:00:00Z"}
                    ]
                },
                "instance_details": {
        ...
        "input": {
            ...
            "original_context": {
                "historical_data": {
                    "time_range": "2023-06-01 to 2024-06-10",
                    "attack_patterns": [
                        {"stage": "Initial Compromise", "description": "Unauthorized access gained through phishing emails targeting key personnel."},
                        {"stage": "Lateral Movement", "description": "Compromised credentials used to access other instances within the network."},
                        {"stage": "Data Exfiltration", "description": "Sensitive data exfiltrated to external IP 203.0.113.1."}
                    ],
                ...
                "instance_details": {
                    ...
                    "region": "us-east-1",
                    "tags": {"Name": "Critical-Infrastructure", "Environment": "Production"},
